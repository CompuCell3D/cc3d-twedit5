    ...
    def _process_imports(self) -> None:
        ...
        if "MembraneFluctuations" in gpd.keys():
            ...
            if isinstance(self.membrane_fluctuations, dict):
                ...
                if (
                    "FunctionName" not in self.membrane_fluctuations.keys()
                    or self.membrane_fluctuations["FunctionName"] not in self.__valid_functions
                ):
