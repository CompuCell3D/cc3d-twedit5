...
class Ui_DevZoneDlg(object):
    def setupUi(self, DevZoneDlg):
        ...
        self.win_cmake_generator_label = QtWidgets.QLabel(DevZoneDlg)
        self.win_cmake_generator_label.setObjectName("win_cmake_generator_label")
        self.verticalLayout.addWidget(self.win_cmake_generator_label)
        ...
        self.win_cmake_generator_CB = QtWidgets.QComboBox(DevZoneDlg)
        self.win_cmake_generator_CB.setObjectName("win_cmake_generator_CB")
        self.verticalLayout_2.addWidget(self.win_cmake_generator_CB)
    ...
    def retranslateUi(self, DevZoneDlg):
        ...
        self.win_cmake_generator_label.setText(_translate("DevZoneDlg", "Windows CMake generator"))
        ...
        self.win_cmake_generator_CB.setToolTip(_translate("DevZoneDlg", "<html><head/><body><p>Select the CMake generator to use on Windows.</p></body></html>"))
