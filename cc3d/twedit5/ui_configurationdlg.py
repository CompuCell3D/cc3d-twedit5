...
class Ui_ConfigurationDlg(object):
    def setupUi(self, ConfigurationDlg):
        ...
        ConfigurationDlg.resize(590, 503)
        ...
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.editingTab)
        ...
        self.editingOptionsFormLayout = QtWidgets.QFormLayout()
        self.editingOptionsFormLayout.setFieldGrowthPolicy(QtWidgets.QFormLayout.FieldsStayAtSizeHint)
        self.editingOptionsFormLayout.setLabelAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.editingOptionsFormLayout.setFormAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.editingOptionsFormLayout.setObjectName("editingOptionsFormLayout")
        ...
        self.editingOptionsFormLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.autoSaveIntervalLabel)
        ...
        self.editingOptionsFormLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.autoSaveIntervalSpinBox)
        ...
        self.editingOptionsFormLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.autocompletionLabel)
        ...
        self.editingOptionsFormLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.autocompletionSpinBox)
        self.verticalLayout.addLayout(self.editingOptionsFormLayout)
        self.verticalLayout_2.addLayout(self.verticalLayout)
        self.horizontalLayout_3.addLayout(self.verticalLayout_2)
        spacerItem1 = QtWidgets.QSpacerItem(177, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.horizontalLayout_3.addItem(spacerItem1)
        spacerItem2 = QtWidgets.QSpacerItem(204, 291, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
